...
\\
\\
We need to linearize all these cases such that, $y = H u$, where H is a matrix. Here we will demonstrate how to d linearization for one case, $\theta >0, \theta < \theta_{ttt}, \theta < \theta_{ttr}$,
\begin{align*}
